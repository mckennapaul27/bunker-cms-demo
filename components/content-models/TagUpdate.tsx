...
import { TagValues, isDisabled, haveFieldsChanged } from '@/utils/form-helpers';
...
export const TagUpdate = ({
    ...
    useConfirmBeforeLeaving(hasChanged, 'Are you sure you want to leave?');
    ...
    const onSubmit: SubmitHandler<TagValues> = async (data) => {
        setLoading(true);
